...
public class Client {
	public static void main(String[] args) {
		...
		try {
			socket = new Socket("localhost", 8888); //클라이언트 소켓 생성. 서버에 연결
			...
			while (true) {
				System.out.print("Client->Server : "); // 프롬프트
				...
				System.out.println("Server->Client : " + inputMessage); // 서버로부터 받은 메시지를 화면에 출력
			}
		} catch (IOException e) {
